<?php
	...
	if(!(function_exists("mysql_connect"))){
		function mysql_connect($mysql_servername='localhost',$mysql_username='assaf',$mysql_db_name='home_test',$mysql_password='mydatabasemysql',$connection_id=0,$mysql_charset="utf8mb4"){
