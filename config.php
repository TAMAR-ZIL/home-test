...
$dotenv->load();
	...
	define("_POST_GET_ON_API_ACCESCLEARS",true);
	...
	define("MYSQL_DEFAULT_USERNAME",$_ENV["{$envPrefix}_DB_USER"]);
	define("MYSQL_DEFAULT_DB_NAME",$_ENV["{$envPrefix}_DB_NAME"]);
	define("MYSQL_DEFAULT_DB_PASSWORD",$_ENV["{$envPrefix}_DB_PASSWORD"]);
	define("ENV",$_ENV["{$envPrefix}_DB_ENV"]);
