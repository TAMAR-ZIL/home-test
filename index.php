		...
		<div id="main" class="main-container row">
			...
			<div id="chat_window" class="right-container col-md-8">
				...
				<form id="send_msg" class="send_msg_form chatbox-input">
					   <!-- Image Upload UI -->
					   <div id="image-upload-container" style="display:inline-block;position:relative;">
						   <label for="image-upload-input" style="cursor:pointer;">
							   <i class="fa-sharp fa-solid fa-paperclip"></i>
						   </label>
						   <input id="image-upload-input" type="file" name="image" accept="image/*" capture="environment" style="display:none;" />
						   <div id="drag-drop-area" style="border:2px dashed #ccc;padding:10px;display:none;position:absolute;top:30px;left:0;background:#fff;z-index:10;">
							   <span>Drag & Drop image here</span>
						   </div>
					   </div>
					   <button  id="emoji-btn">☺</button>
					   <button id="record_btn" class="voice-btn">
						   <img id="record_img" src="assets\images\voice-message-icon-vector-isolated-chat-symbol-flat-197058076.webp" alt="Record">
					   </button>
					   <div id="voice_preview"></div>
